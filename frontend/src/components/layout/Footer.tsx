...
//                     © 2026 <span className="font-semibold">Smart Touch Infotech Private Limited</span>. | Open Source.
//                 </p>
...
export const Footer: React.FC = () => {
    ...
    return (
        <>
            ...
            >
                <p className={`mb-1 ${subTextClass}`}>
                    © 2026 <span className="font-semibold">
            ...
            {openSourceOpen && (
                ...
                >
                    <div
                        onClick={(e) => e.stopPropagation()}
                        className={`w-full max-w-xl mx-4 rounded-lg shadow-xl flex flex-col
                    ...
                    >
                        ...
                        ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
                            ...
                            <button
                                onClick={() => setOpenSourceOpen(false)}
                                className="text-xl px-2 py-1 rounded hover:bg-gray-500/20"
                            >
                                ✕
                            </button>
                        </div>
                        ...
                        <div className="px-6 py-4 space-y-4 text-sm leading-relaxed">
                            ...
                            <p>
                                The complete corresponding source code for this
                                service, including all modifications, is
                                available at:
                            </p>

                            <a
                                href="https://github.com/shineedbasheer/openalgo-stream"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-blue-500 underline hover:text-blue-600 break-all"
                            >
                                https://github.com/shineedbasheer/openalgo-stream
                            </a>
                        </div>
